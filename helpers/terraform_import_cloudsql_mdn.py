...
def get_sql(project_id):
    ...
    try:
        ...
        terraform_module = "cloudsql_mdn"
        instance_module_name = "mdn_db_instance"
        db_module_name ="rmin_mdn_db"
        db_name = "rmin_mail_delivery_notification_db" 
        db_user_module_name = "rmin_mdn_db_user"        
        db_user_secret_module_name = "rmin_mdn_db_user_secret" 
        db_root_secret_module_name = "mdn_db_instance_root_serect"  
        db_user_secret_ver_module_name = "rmin_mdn_db_user_secret_latest" 
        db_root_secret_ver_module_name = "mdn_db_instance_root_serect_latest" 
        bq_conn_module_name = "rmin_mdn_db_external_connection"        
        env = getConfig(project_id, "environment")
        instance_name = "idc-"+env+"-rmin-mail-delivery-notification-c"
        db_user = getConfig(project_id, "rmin_mdn_db_user_name")
        db_user_secret_id = "rmin-mail-delivery-notification-"+db_user+"-key-c"
        root_secret_id = "rmin-mail-delivery-notification-postgres-key-c"
        bq_location = "us-central1"
        bq_connection_id = "rmin_mail_delivery_notification_db_connection_c"
